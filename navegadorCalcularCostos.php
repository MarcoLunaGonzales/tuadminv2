...
{	var rpt_territorio, rpt_almacen,fecha_ini, fecha_fin, tipo_item, rpt_item;
	...
	window.open('calcularCostosPromedio.php?rpt_territorio='+rpt_territorio+'&rpt_almacen='+rpt_almacen+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');			
	return(true);
}
...
echo "<table align='center' class='textotit'><tr><th>Calcular Costos de Materiales</th></tr></table><br>";

echo"<form method='post' action='navegadorCalcularCostos.php'>";
