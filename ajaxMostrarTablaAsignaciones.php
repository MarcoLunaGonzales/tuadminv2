...
{ $personal=$dat[0];
  ...
  $boton='<div class="btn-group"><a class="btn btn-sm '.$btnFavo.' btn-fab" href="predeterminarAsignacion.php?p='.$user.'&c='.$ciudad.'"><img src="imagenes/enter.png" width="35"></img></a><a class="btn btn-sm btn-danger btn-fab" href="deleteAsignacion.php?p='.$user.'&c='.$ciudad.'"><img src="imagenes/eliminarproceso.gif" width="35"></img></a></div>';
  if($i%2==0){
