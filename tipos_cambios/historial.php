	...
	<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header card-header-primary card-header-text">
					<div class="card-text">
					  <h4 class="card-title">Editar Tipo de Cambio</h4>
					</div>
				</div>
				<div class="card-body ">
					<div class="row">
                  ...
                  while ($row = mysqli_fetch_array($resp)) {
				 	...
				 	?>
						...
						<div class="form-group col-sm-1">
						  		<select class="selectpicker form-control" data-style="btn btn-info"name="sel_ano" id="sel_ano" onchange="cargarTipoCambio(<?=$globalCode?>)">
						  			<?php 
						...
						<div class="form-group col-sm-2">
						  		<select class="selectpicker form-control" data-style="btn btn-info" name="sel_mes" id="sel_mes" onchange="cargarTipoCambio(<?=$globalCode?>)">
						  			<?php 
                                   for ($i=1; $i < 13; $i++) { 
                                   	   if($i==(int)$m){
				...
				<div class="card-body ">
					<fieldset id="fiel" style="width:100%;border:0;">
				  	...
				  	<div class="card-footer fixed-bottom">
						...
						<a class="btn btn-danger" href="list.php">Volver</a>
				  	</div>
			  </div><!--card end-->
		 </div>	
      </div>
