...
{	var rpt_territorio,fecha_ini, fecha_fin, rpt_ver;
	...
	window.open('rptVentasxItemCosto.php?rpt_territorio='+rpt_territorio+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');			
	return(true);
}
</script>
<?php
...
echo "<table align='center' class='textotit'><tr><th>Reporte de Costo de Venta x Item</th></tr></table><br>";
