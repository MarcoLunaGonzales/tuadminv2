...
if($banderaErrorFacturacion==0){
	echo "<div class='divBotones2' style='display:none;'>
			...
			<tr>
				...
				<td>
				<a href='#' class='btn btn-default btn-sm' style='background:#FF0000' onclick='validarCotizacion(form1); return false;' id='boton_cotizacion'><i class='material-icons'>file_download</i>Guardar Cotización</a>
				</td>
             </tr>
            </table>
