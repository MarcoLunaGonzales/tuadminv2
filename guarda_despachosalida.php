...
if ($sql_cabecera) {
    ...
    if(!empty($codigo) && $codigo > 0){
        ...
        $sql_eliminar_detalle = mysql_query($consulta_eliminar_detalle);
    }
    ...
    foreach ($data['items'] as $item) {
        ...
        $sql_inserta_detalle = mysql_query($consulta_detalle);
    }
