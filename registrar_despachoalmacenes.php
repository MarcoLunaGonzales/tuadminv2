...
if($edit_tipo == 1){
	...
	if ($row = mysql_fetch_assoc($result)) { // Verificación de Registro encontrado
	...
	<table border="0" class="table" cellspacing="0" align="center" style="border:#ccc 1px solid;">
		<tbody>
			<tr>
				...
				<th>Funcionario</th>
				<td align="center">
					<select class="form-control selectpicker" name="funcionario" id="funcionario" data-live-search="true" <?=($edit_tipo == 0 ? '':'disabled')?>>
						<?php
