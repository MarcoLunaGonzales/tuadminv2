...
<div class="content text-center">
	<h3 class="font-weight-bold text-primary">Reporte de Ventas por Grupo</h3>
</div>
   	 	...
   	 	<div class="row">
      		<div class="card">
        		<div class="card-header card-header-success card-header-icon">
                  	<div class="card-icon">
                      	<i class="material-icons">bar_chart</i> Ventas por Grupo
                  	</div>
        		</div>
...
<script>
	...
	function graficoVentaDimension() {
		$.ajax({
			url: 'backendGrafico/rptVentaDimensionGrupo.php',
			type: 'POST',
			data: {
	...
	function graficoVentaDimensionMes() {
		$.ajax({
			url: 'backendGrafico/rptVentaDimensionGrupoMes.php',
			type: 'POST',
			data: {
				fecha_inicio: <?= "'".$fecha_iniconsulta."'" ?>,
				fecha_fin: <?= "'".$fecha_finconsulta."'" ?>,
			...
			success: function(response) {
				...
				var options = {
					...
					title: {
						text: 'Monto de Venta por Grupo y Mes'
					},
					yaxis: {
						title: {
							text: 'Monto de Venta'
