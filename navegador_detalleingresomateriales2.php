...
<?php	
	...
	$sql2="select count(*) nroItems, sum(i.cantidad_unitaria*i.precio_neto) total from ingreso_detalle_almacenes i where i.cod_ingreso_almacen='".$codIngreso."'"; 
	//echo $sql2;
	...
	$sql_detalle="select m.codigo_anterior, i.cantidad_unitaria, i.precio_neto, i.lote, DATE_FORMAT(i.fecha_vencimiento, '%d/%m/%Y'),
	m.descripcion_material, m.codigo_material	from ingreso_detalle_almacenes i, material_apoyo m
...
?>
	...
	<tr><th>&nbsp;</th><th>Codigo</th><th>Material</th><th>Cantidad</th><th>Lote</th><th>Precio(Bs.)</th><th>Total(Bs.)</th>
	<th>Participacion %</th>
<?php	
...
?>		
		<th><?=$datCii['nombre_costoimp'];?><br><?=$montoCiiFormato;?><br>(<?=$tipoCalculo;?>)</th>
...
?>
<tr>
<td align='center'><?=$indice;?></td><td><?=$cod_material;?></td><td><?=$nombre_material;?></td><td align='center'><?=$cantidad_unitaria;?></td>
		<td align='right'><?=$loteProducto;?></td>
...
?>
			<td align="right"><?=$auxCostoImpProd;?></td>
<?php			
		}
		$totalCostoImpProd=$totalCostoImpProd+$costoImpProd;
		
?>		
			<td align="right"><?=$costoImpProd;?></td>
