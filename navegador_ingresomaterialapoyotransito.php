...
echo "<script language='Javascript'>
		...
		function editar_nav(f)
		{
			...
			else
			{
				...
				{
					location.href='registrar_ingresotransito.php?codigo_registro='+j_cod_registro+'&grupo_ingreso=2';
				}
			}
		}
		</script>";
	echo "<form method='post' action=''>";
	$sql="select s.cod_salida_almacenes, s.cod_almacen, s.fecha, ts.nombre_tiposalida, c.descripcion, a.nombre_almacen, s.observaciones, s.nro_correlativo 
	...
	while($dat=mysql_fetch_array($resp))
	{
		...
		echo "<tr><td><input type='checkbox' name='codigo' value='$codigo'></td><td align='center'>$fecha_salida_mostrar</td><td>$nombre_tiposalida</td><td>$nombre_almacen_origen $ciudad_almacen_origen</td><td align='center'>$nro_correlativo</td><td>&nbsp;$obs_salida</td><td>&nbsp;</td><td><a target='_BLANK' href='navegador_detallesalidamuestrastransito.php?codigo_salida=$codigo&almacen_origen=$cod_almacen_origen&grupo_salida=2'>";
		echo "<img src='imagenes/detalles.gif' border='0' alt='Ver Detalles'> Detalles de Ingreso</a></td>";
