...
{	var fecha_ini;
	...
	window.open('rptArqueoDiarioServiteca.php?rpt_territorio='+rpt_territorio+'&fecha_ini='+fecha_ini+'&variableAdmin='+variableAdmin,'','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');			
	return(true);
}
</script>
<?php
...
echo "<table align='center' class='textotit'><tr><th>Reporte Arqueo Diario de Caja Serviteca</th></tr></table><br>";
