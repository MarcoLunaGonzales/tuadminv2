...
$sql_inserta=mysql_query("insert into ingreso_almacenes values($codigo,$global_almacen,1001,'$fecha_real','$hora_sistema','Por devolucion de ciclo. Visitador: $nombreVisitador',1,0,'0','$nro_correlativo',0)");
