...
if (empty($ch_nombre) || empty($ch_nro_licencia) || empty($ch_celular)) {
    $response = array(
        'success' => false,
...
$sql = "INSERT INTO transportistas (nombre, nro_licencia, celular) VALUES ('$ch_nombre', '$ch_nro_licencia', '$ch_celular')";
