...
$sql = "SELECT estado FROM transportistas WHERE codigo = '$codigo'";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    // Actualiza el estado de la transportistas en la base de datos
    $sqlUpdate = "UPDATE transportistas SET estado = '$nuevoEstado' WHERE codigo = '$codigo'";
