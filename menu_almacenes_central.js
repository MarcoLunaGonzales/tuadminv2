...
submenuItem("B�squeda",loc+"../"+"navegador_salidabusqueda.php?grupo_salida=2","","menu_almacenes_central_plain");
...
submenuItem("B�squeda",loc+"../"+"navegador_salidabusqueda.php?grupo_salida=1","","menu_almacenes_central_plain");
...
submenuItem("B�squeda",loc+"../"+"navegador_ingresobusqueda.php?grupo_ingreso=2","","menu_almacenes_central_plain");
...
submenuItem("B�squeda",loc+"../"+"navegador_ingresobusqueda.php?grupo_ingreso=1","","menu_almacenes_central_plain");
...
submenuItem("Ingreso de Producto de Apoyo en Tr�nsito",loc+"../"+"navegador_ingresomaterialapoyotransito.php","","menu_almacenes_central_plain");
