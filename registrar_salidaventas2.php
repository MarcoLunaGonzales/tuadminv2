...
<fieldset id="fiel" style="width:100%;border:0;">
	...
	<?php
		...
		if($codigo_venta_duplicado!=0){
			$sql = "SELECT ma.codigo_material, CONCAT(ma.descripcion_material, '(',ma.codigo_material,')') as nombre_material, sda.precio_unitario, sda.cantidad_unitaria, sda.descuento_unitario
	...
	<td width="30%" align="center">
		<input type="hidden" name="materiales<?php echo $num;?>" id="materiales<?php echo $num;?>" value="<?=$dup_codigo;?>">
		<div id="cod_material<?php echo $num;?>" class='textomedianonegro'><?=$dup_nombre_material;?></div>
	</td>
	...
	<td align="center" width="12%">
		...
		<div id='idprecio<?php echo $num;?>'>
			<input class="inputnumber" type="number" min="1" value="<?=$precio;?>" id="precio_unitario<?php echo $num;?>" name="precio_unitario<?php echo $num;?>" onKeyUp='calculaMontoMaterial(<?php echo $num;?>);' onChange='calculaMontoMaterial(<?php echo $num;?>);' step="0.01" required>
		</div>
	</td>

	<td align="center" width="15%">
		<input class="inputnumber" type="number" id="descuentoProducto<?php echo $num;?>" name="descuentoProducto<?php echo $num;?>" onKeyUp='calculaMontoMaterial(<?php echo $num;?>);' onChange='calculaMontoMaterial(<?php echo $num;?>);'  value="<?=$dup_descuento;?>" step="0.01">
	</td>

	<td align="center" width="10%">
		<input class="inputnumber" type="number" id="montoMaterial<?php echo $num;?>" name="montoMaterial<?php echo $num;?>" value="<?php echo $dup_total;?>"  step="0.01"  required readonly> 
	</td>
...
<?php
	...
	echo "
	<script>
		var f= {materialActivo:{value:$num}};
		masV(0);
		setMateriales(f, $dup_codigo, '$dup_nombre_material');
		num=$num;
		cantidad_items=$num;
	</script>";	
