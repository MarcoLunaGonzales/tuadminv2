...
try { 
      ...
      $plaintext = $hashSectorFirma;

      $rsa->setEncryptionMode(CRYPT_RSA_ENCRYPTION_PKCS1);
      $crypttext = $rsa->encrypt($plaintext);
...
$signature=$firmaXml.'<SignatureValue>'.$encriptFirma.'</SignatureValue><KeyInfo>
      <X509Data>
        <X509Certificate>
uoQSDXdYy5gkFJ+czLtQYOtv</X509Certificate>
      </X509Data>
    </KeyInfo></Signature>';
...
//$documentoFiscal=$archivoPre."</facturaElectronicaCompraVenta>";
...
//$documentoFiscal=file_get_contents("45D4083F1463611231430260A22EC4A3C044F590739808651EE146D74.xml");
