...
{   
    ...
    {   if(j==0)
        ...
        {  
            Swal.fire({
                title: '¿Estás seguro de anular pago?',
...
<form method='post' name='form1' action=''>
    <h2>Registro de Obligaciones </h2>
