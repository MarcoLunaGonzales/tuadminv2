...
echo "<h1>Reporte Arqueo Diario de Caja Serviteca</h1>
...
$sql="select s.`fecha`,  
	...
	s.hora_salida, s.cod_salida_almacenes
...
while($datos=mysql_fetch_array($resp)){	
	...
	$txtDetalle="<table class='textomini' border=0 width='100%'>
	<tr><th width='40%'>Desc.</th><th width='15%'>Cant.</th><th width='15%'>Precio</th><th width='15%'>Desc.</th><th width='15%'>Monto</th></tr>";
	while($datDetalle=mysql_fetch_array($respDetalle)){
		...
		$txtDetalle.="<tr><td>$nombreMat</td><td>$cantUnit</td><td>$precioUnit</td><td>$descUnit</td><td>$montoUnit</td></tr>";
	}
	$txtDetalle.="</table>";
