...
<th>Producto</th><th>Cantidad Traspaso</th><th>Fecha Ingreso</th><th>Cantidad Ingreso</th></tr>";
while($dat=mysql_fetch_array($resp))
{
	...
	$sqlIngreso="select CONCAT(i.fecha,' ',i.hora_ingreso)as fecha, id.cod_material, id.cantidad_unitaria from ingreso_almacenes i, ingreso_detalle_almacenes id where i.cod_ingreso_almacen=id.cod_ingreso_almacen and id.cod_material='$codProducto' and i.cod_salida_almacen='$codSalidaAlmacen'";
	...
	<td bgcolor='#00FFA6'>$fechaIngreso</td><td bgcolor='#00FFA6'>$cantidadIngreso</td>
	</tr>";
