...
echo "<center><table border='0' class='textotit'><tr><td>Editar Tipos de Producto</td></tr></table></center><br>";
echo "<center><table border='1' class='texto' cellspacing='0'>";
echo "<tr><th align='left'>Nombre de Tipo de Producto</th>";
...
echo "<tr><th align='left'>Definici�n de Tipo de Producto</th>";
