...
echo"<form method='post' action='rptOpKardexCostos.php'>";
	...
	echo "<tr><th align='left'>Almacén</th><td><select name='rpt_territorio' class='selectpicker' data-style='btn btn-info' data-show-subtext='true' data-live-search='true'>";
