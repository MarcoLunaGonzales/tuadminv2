...
echo "<center><table border='0' class='textotit'><tr><td>Adicionar Tipos de Producto</td></tr></table></center><br>";
echo "<center><table border='1' class='texto' cellspacing='0'>";
echo "<tr><th align='left'>Nombre Tipo de Producto</th>";
...
echo "<tr><th align='left'>Definici�n Tipo de Producto</th>";
