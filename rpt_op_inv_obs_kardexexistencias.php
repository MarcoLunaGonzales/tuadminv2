...
echo "<script language='JavaScript'>
		...
		{	var rpt_territorio, rpt_almacen, tipo_salida,fecha_ini, fecha_fin, tipo_item, rpt_linea,tipo_reporte;
			...
			rpt_almacen=f.rpt_almacen.value;
			tipo_item=f.tipo_item.value;
			window.open('rpt_inv_obs_kardexexistencias_xls.php?rpt_territorio='+rpt_territorio+'&rpt_almacen='+rpt_almacen+'&tipo_item='+tipo_item+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');			
			return(true);
		}
