...
if(empty($codigo)){
    // Nuevo
    $consulta = "INSERT INTO despacho_productos (cod_ciudad, fecha_entrega, cod_funcionario, observaciones, created_by, created_at, cod_vehiculo) 
                VALUES ('$global_agencia', '$fecha_entrega', '$codigoFuncionario', '$observaciones', '$created_by', '$created_at','$vehiculo')";
